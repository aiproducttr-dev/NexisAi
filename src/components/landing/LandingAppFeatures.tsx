...
const APP_FEATURES = [
  {
    ...
    description:
      "İşletmenize ve sektörünüze özel profesyonel tanıtım içerikleri hazırlanır. Siz uğraşmayın, biz halledelim.",
    detail:
      "Kategori bazlı içerik stratejisi ile işletme adınız, şehriniz ve sektörünüz doğal şekilde içeriğe entegre edilir.",
  },
  {
    id: "publish",
    icon: "🌐",
    title: "Anında Yayın",
    description:
      "Kampanya başladığında içerikleriniz NexisAI çatısı altında otomatik olarak yayına alınır.",
    detail:
      "Manuel müdahale gerekmez. İçerik üretimi ve yayın süreci tamamen otomatiktir.",
  },
  {
    id: "panel",
    icon: "📊",
    ...
    description:
      "Tüm kampanyalarınızı tek panelden yönetin. Bütçe, süre ve yayın durumunu anlık takip edin.",
    detail:
      "Şeffaf fiyatlandırma: günlük bütçe × kampanya süresi. Gizli ücret veya ek masraf yoktur.",
  },
] as const;
    ...
    <section className="pb-24 pt-4" id="features">
      <div className="mb-14 text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-[#94a3b8]">
          İçerik üretiminden yayına, yönetimden takibe kadar
          işletmenizin ihtiyaç duyduğu tüm süreçler tek platformda.
        </p>
      </div>
